      ...
      <div className="Info">
        <div className="md:col-span-1 mx-3 border rounded-[20px]">
          <div className=" bg-black py-2 px-4 rounded-t-[20px] text-white">
            <h1 className="font-bold text-xl px-4 py-4">El Maqam</h1>
          </div>
          <ul className="my-4">
            <li className="py-2 px-6 lg:text-xl text-lg font-semibold justify-between w-full text-black flex items-center gap-2">
